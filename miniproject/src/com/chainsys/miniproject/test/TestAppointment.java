...
public class TestAppointment {
			...
			public static void testgetAllAppointments()
			{
				...
				while(appIterator.hasNext())
				{
					...
					System.out.println(app.getAPPOIMENT_ID()+" "+app.getAPPOIMENT_DATE()+" "+app.getDOC_ID()+" "+app.getPATIENT_NAME()+" "+app.getFEES_COLLECTED());
					}
			}
			...
			public static void testUpdateAppointment()
			{
				...
				System.out.println(oldApp.getAPPOIMENT_ID()+" "+oldApp.getAPPOIMENT_DATE()+" "+oldApp.getDOC_ID()+" "+oldApp.getPATIENT_NAME()+" "+oldApp.getFEES_COLLECTED());
